...
>
> It is in private beta and free right now, with full access and no credit card. I am a final-year BBA student at BI Norway, heading to the MSc in Banking and Finance at St. Gallen.
>
> If you are preparing for the GMAT, you are welcome to try it: https://www.zakariangmat.com

---

## Pinned post

A founder/origin post that works as an evergreen pinned intro. Honest, no hype, no fake urgency. The beta link is in-text; a first-comment note is included as an alternative if you prefer to keep the post body clean.
...
>
> I rebuilt all of that into the prep platform I wish I had started with. Zakarian GMAT has 50+ chapters across Quant, Verbal, and Data Insights, 1,900+ original questions, full-length mocks, an error log with a spaced review queue, and analytics on accuracy and pacing.
>
> It is in private beta and free right now, with full access and no credit card. If you are studying for the GMAT, come try it: https://www.zakariangmat.com
>
> GMAT is a registered trademark of GMAC, which does not endorse and is not affiliated with this product.

**First-comment alternative** (use if you want the post body link-free, which sometimes helps reach):
> Link is here if you want to try it during the free private beta: https://www.zakariangmat.com

---

## Email signature

No affiliation claim, short and honest.

> Adam Zakarian
> Founder, Zakarian GMAT - focused GMAT Focus Edition prep
> https://www.zakariangmat.com
> 565 to 735, built solo. Free during private beta.
...
A short, shareable blurb a friend can forward as-is. No pressure, no claims.

> If you are studying for the GMAT, you might like this. A friend built Zakarian GMAT, a GMAT Focus Edition prep platform with 50+ chapters, 1,900+ practice questions, full-length mocks, and an error log with spaced review. It is in private beta and completely free right now, no credit card. Worth a look: https://www.zakariangmat.com

**Invite link format**

Use a referral-tagged homepage link so the visit is attributed correctly (first-touch utm is captured on landing and merged into every analytics event, and a signup from this link is counted as a referral signup):

> https://www.zakariangmat.com/?utm_source=referral

You can add a campaign tag if you want to tell sources apart, for example:

> https://www.zakariangmat.com/?utm_source=referral&utm_campaign=friend_invite

**Note on the invite code**

Signup is currently open in production, so the plain referral link above is all anyone needs. If signup is ever gated, the signup page accepts an invite code that pre-fills automatically with this format:

> https://www.zakariangmat.com/?invite=CODE

Replace `CODE` with the actual invite code only when gating is on. While signup is open, the `?utm_source=referral` link is enough.

For the in-app sharing path (the InviteFriend component on the dashboard and mock report) and the /refer page, see `EMAIL_SEQUENCES.md` and `../REFERRAL_AND_DISCOUNT_PLAN.md`.
