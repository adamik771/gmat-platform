...
const PERSONA_PATHS: Record<PersonaPathKey, PersonaPathDef> = {
  "foundations-rebuilder": {
    ...
    steps: [
      ...
      {
        href: "/chapters/verbal-1-foundations",
        section: "Verbal",
        label: "Verbal Foundations",
        why: "Active reading + argument anatomy — the shared base under CR and RC.",
        completionTag: "chapter-started:verbal-1-foundations",
      },
      {
        href: "/chapters/verbal-2-cr-core-logic",
        section: "Verbal",
        label: "CR Core Logic",
        why: "Argument mechanics — the structure that CR and half of RC share.",
        completionTag: "chapter-started:verbal-2-cr-core-logic",
      },
      {
