  ...
  if (showResults) {
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {/* What to do next — surfaces the pre-computed guidance immediately
            after the score card so students never have to scroll to find their
            path. Comprehensive accuracy-band logic: <60 → chapter, 60-80 →
            practice again, ≥80 + weak topic → address the gap. */}
        {answeredCount > 0 && (() => {
          const isPractice =
