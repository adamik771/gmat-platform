  ...
  if (showResults) {
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {/* What to do next — the single decisive next-step for the session.
            Closes the "session finished, now what?" dead end with 1-2 CTAs
            keyed to the accuracy band, and to mixed-review / known-weak-topic
            context when available. Sits above the wrong-answer review list so
            the forward path is visible without scrolling past every miss. */}
        {answeredCount > 0 && (() => {
          const isPractice =
