    ...
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div
          ...
          style={
            accuracy >= 85
              ? { borderColor: "rgba(62,207,142,0.22)", backgroundColor: "rgba(62,207,142,0.04)" }
              : accuracy < 60
              ? { borderColor: "rgba(255,68,68,0.14)", backgroundColor: "rgba(255,68,68,0.025)" }
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div>
              ...
              <p
                ...
                style={{ color: accuracy >= 85 ? "#3ECF8E" : accuracy < 60 ? "#FF6B6B" : "#C9A84C" }}
              >
                {accuracy}%
              </p>
            </div>
