      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {answeredCount > 0 && (() => {
          ...
          if (isMixedReview) {
            ...
            // Strong session, no specific weak topic surfaced — point at the
            // adaptive study plan so the next move is strategic rather than a
            // generic "browse chapters" dead end.
