  ...
  if (showResults) {
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {/* What to do next — placed immediately after the score so the student
            sees the path forward before scrolling into analytics. */}
        {answeredCount > 0 && (() => {
          const isPractice =
          ...
          return (
            ...
            >
              <p className="text-[10px] uppercase tracking-widest mb-2" style={{ color: "#C9A84C" }}>
                Your next step
              </p>
