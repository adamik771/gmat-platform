  ...
  if (showResults) {
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {/* What to do next — the first decision after seeing the score. Keyed
            to accuracy band; names the weakest topic directly when the session
            was strong and the server identified a gap. */}
        {answeredCount > 0 && (() => {
          const isPractice =
