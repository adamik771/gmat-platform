      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {answeredCount > 0 && (() => {
          ...
          if (isMixedReview) {
            ...
            // Strong performers benefit most from the adaptive plan to decide
            // where to invest next — keep that path one click away.
            actions.push({ label: "View study plan", href: "/study-plan", variant: "secondary" })
          } else {
            // Strong session, no cross-topic weak area surfaced yet: send the
            // student to the adaptive plan to choose the next high-leverage move.
            actions.push({ label: "View study plan", href: "/study-plan", variant: "primary" })
