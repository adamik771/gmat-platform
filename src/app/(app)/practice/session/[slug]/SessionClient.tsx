              ...
              <div className="space-y-2">
                {hcMisses.map(({ q, state, idx }) => (
                  ...
                  >
                    ...
                    {!q.twoPartCorrectAnswers && (
                        <p
                          className="text-xs mt-0.5 truncate"
                          style={{ color: "rgba(62,207,142,0.6)" }}
                        >
                          Correct: {q.correctAnswerLetter}
                          {q.options[q.correctAnswer]
                            ? ` — ${q.options[q.correctAnswer].replace(/\s+/g, " ").slice(0, 55)}`
                            : ""}
                        </p>
                      )}
                    </div>
                      ...
                      >
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <div className="min-w-0">
                            ...
                            {isWrong && state.selected !== null && !q.twoPartCorrectAnswers && (
                              <p
