  ...
  if (showResults) {
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {/* What to do next — single decisive CTA block with full accuracy-band
            logic. Appears before the question review list so students see their
            next direction without scrolling past all wrong answers first. */}
        {answeredCount > 0 && (() => {
          const isPractice =
