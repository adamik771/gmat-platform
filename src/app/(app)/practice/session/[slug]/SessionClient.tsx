  ...
  if (showResults) {
    ...
    if (answeredCount > 0) {
      if (accuracy >= 85) {
        ...
        headline = "The gaps are clear now."
      }
    }
    ...
    return (
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {/* What to do next — placed before the question review list so the
            student's path forward is clear before they dive into the post-mortem.
            Keyed to the accuracy band and whether a weaker topic is known. */}
        {answeredCount > 0 && (() => {
          const isPractice =
