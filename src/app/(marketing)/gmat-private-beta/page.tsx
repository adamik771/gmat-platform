...
export const metadata: Metadata = {
  title: "GMAT Founding Access: Free 7-Day Trial",
  description: `Zakarian GMAT founding access — a free 7-day full-access trial, no card: ${CHAPTER_COUNT_CLAIM} Focus Edition chapters, 1,900+ questions, a 6-tag error log, spaced review, and an adaptive plan built from your own official practice exam. Founding members lock in early pricing.`,
...
const DATA: AcquisitionLandingProps = {
  ...
  "lead": {
    ...
    "description": "Get the exact 6-tag error log Adam used to find and kill his score leaks — the same Conceptual / Careless / Time Pressure / Misread / Strategy / Other system built into the platform, as a downloadable template you can start today. Drop your email and I'll send it, plus your founding access. No card, no charge — you reserve your founding rate and decide later.",
    "ctaLabel": "Reserve my spot"
  },
  "metaDescription": `Zakarian GMAT founding access — a free 7-day full-access trial, no card: ${CHAPTER_COUNT_CLAIM} Focus Edition chapters, 1,900+ questions, a 6-tag error log, spaced review, and an adaptive plan built from your own official practice exam. Founding members lock in early pricing.`
}
