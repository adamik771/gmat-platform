...
const DATA: AcquisitionLandingProps = {
  ...
  "faq": [
    ...
    },
    {
      ...
      "a": "No. The method on this page, drill one format to fluency, log every miss by cause, review with pacing in mind, and re-attempt misses after a gap, works in a notebook or spreadsheet. A platform helps mainly by automating the error log, spaced review, and per-format analytics so you spend time practicing instead of bookkeeping. Zakarian GMAT does that — with a free 7-day full-access trial, no card — but the discipline is what moves your score, not the tool."
    }
  ],
  "lead": {
    "source": "other",
