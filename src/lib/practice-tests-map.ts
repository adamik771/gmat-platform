...
export const BANK_RULES: Record<string, SubtopicRule[]> = {
  arithmetic: [
    ...
    { match: ["arithmetic sequence"], chapter: "quant-16-functions-sequences" },
    { match: ["counting factors"], chapter: "quant-09-divisibility-factors" },
    { match: ["average"], chapter: "quant-23-statistics" },
    { match: ["answer choice tactics"], chapter: "quant-04-answer-choice-tactics" },
    { match: ["timing strategy"], chapter: "quant-30-timing" },
    ...
    { match: ["fraction", "decimal"], chapter: "quant-06-fractions-decimals" },
  ...
  "exponents-roots": [
    ...
    { match: ["exponent", "power", "scientific notation"], chapter: "quant-11-exponent-rules" },
  ...
  algebra: [
    ...
    { match: ["symmetric sums"], chapter: "quant-16-functions-sequences" },
    { match: ["exponents"], chapter: "quant-11-exponent-rules" },
    { match: ["word problem", "translation", "relative motion", "age"], chapter: "quant-17-translating-word-problems" },
    { match: ["linear", "system", "rational equation"], chapter: "quant-13-linear-equations-systems" },
  ...
  "rates-work": [
    { match: ["combined work", "combined rates", "competing rates", "work rate", "work with", "work", "worker", "machine", "job", "joint-and-solo", "team size", "inlet", "outlet", "production rate"], chapter: "quant-22-work-rate" },
    { match: ["rate", "speed", "moving", "distance", "train", "current"], chapter: "quant-21-rate-time-distance" },
  ...
  "statistics-probability": [
    ...
    { match: ["mean", "median", "mode", "average", "standard deviation", "range", "percentile"], chapter: "quant-23-statistics" },
  ...
  combinatorics: [
    ...
    { match: ["combination", "permutation"], chapter: "quant-25-permutations-combinations" },
  ...
  "word-problems": [
    ...
    { match: ["interest", "profit", "loss", "cost/revenue", "investment"], chapter: "quant-19-percents" },
    { match: ["inverse proportion"], chapter: "quant-22-work-rate" },
    { match: ["rate", "distance", "meeting", "multi-leg", "average speed"], chapter: "quant-21-rate-time-distance" },
    { match: ["average"], chapter: "quant-23-statistics" },
    { match: ["age problem", "consecutive integer", "consecutive even", "coin problem", "digit problem", "classic word problem", "distribution", "payroll", "revenue optimization"], chapter: "quant-28-classic-word-problems" },
