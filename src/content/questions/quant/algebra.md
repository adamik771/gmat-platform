...
**mistake_d:** Correctly found x = 4 by adding the equations, but made an arithmetic slip when back-substituting: 3(4) + 2y = 16 → 2y = 4, then wrote y = 3 (off by one); sum = 4 + 3 = 7.
