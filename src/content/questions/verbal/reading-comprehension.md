...
**answer:** B
**explanation:** The passage moves from introducing the subscription model's appeal, to discussing its core challenge (the "leaky bucket" problem), to surveying three different strategic responses. This arc is best captured by answer B. Answer A is wrong because the passage does not advocate for the model; it discusses its problems. Answer C is too narrow, as dark patterns are mentioned only briefly. Answer D overstates the passage's critique; it does not claim unsustainability. Answer E describes only the first paragraph, not the passage as a whole.
...
**answer:** C
**explanation:** The passage explicitly defines the "leaky bucket" problem: "companies must continuously pour new customers into the top of the funnel simply to maintain flat revenue, let alone grow." Answer C paraphrases this definition accurately. The other options describe problems not mentioned in the passage.
...
**answer:** B
**explanation:** The passage contrasts dark patterns (making cancellation difficult) with strategies that increase genuine value (personalization and switching costs). By describing dark patterns as making service "merely more difficult to leave" rather than more valuable, the passage implies these companies are not addressing why customers want to leave in the first place. Answer A contradicts the passage's tone, which favors value-building strategies. Answer C is not stated or implied. Answer D is unsupported. Answer E is unlikely given that the passage presents all three strategies as known approaches.
...
**answer:** C
**explanation:** The passage identifies the most successful strategy as "building genuine switching costs through network effects, proprietary content, or ecosystem integration, making the service more valuable the longer a customer uses it." Answer C exemplifies this approach with accumulated data, connections, and customization. Answer B resembles dark patterns (making it harder to leave). Answers A, D, and E focus on acquisition or pricing rather than building intrinsic value that increases with use.
...
**answer:** C
**explanation:** The passage systematically builds from physical ingestion, to chemical vectoring, to biomagnification, presenting microplastics as a multi-layered threat. Answer C captures this comprehensive scope. Answer A understates the extent of current knowledge presented. Answer B describes only one aspect discussed in the passage. Answers D and E introduce topics not discussed in the passage.
...
**answer:** B
**explanation:** The passage states explicitly that microplastics' "hydrophobic surfaces attract and concentrate persistent organic pollutants such as PCBs and DDT from surrounding seawater, often at concentrations millions of times higher than ambient levels." This directly matches answer B. The other options either misstate or fabricate mechanisms not described in the passage.
...
**answer:** B
**explanation:** The passage states that through biomagnification, "the concentration of harmful chemicals increases at each trophic level" and that "apex predators, many of which are already endangered, face disproportionately high exposure." The concern is the combination of highest toxic concentration and pre-existing endangerment. Answer A is not stated. Answer C may be true but is not the passage's specific concern about apex predators. Answers D and E introduce information not found in the passage.
...
**answer:** A
**explanation:** The passage identifies two primary sources of microplastics: fragmentation of larger plastics and "the direct release of manufactured microbeads found in personal care products, synthetic textile fibers shed during laundry, and industrial abrasives." Answer A directly targets two of these named sources. Answer B targets larger debris, not microplastics specifically. Answer C addresses fishing but not plastic sources. Answers D and E deal with consequences rather than sources.
...
**answer:** B
**explanation:** The passage follows a three-part structure: establishing the urban mental health problem, explaining the neuroscience, and introducing mitigating design factors. Answer B captures all three elements. Answer A misrepresents the passage's nuanced conclusion. Answer C is too narrow, covering only the first paragraph's setup. Answer D focuses solely on the second paragraph. Answer E is a policy recommendation the passage implies but does not explicitly advocate.
...
**answer:** C
**explanation:** The passage states that "chronic activation of this stress circuitry is associated with elevated cortisol levels, which over time can impair hippocampal function, reducing memory consolidation and emotional regulation." Answer C is a direct paraphrase. The other answers either contradict or are not supported by the passage.
...
**answer:** C
**explanation:** The final paragraph states that the mental health burden "is not an inevitable consequence of density but rather a product of how cities are built and governed." This directly implies that design choices, not density itself, are the primary driver, which matches answer C. Answer A contradicts the passage's emphasis on environmental factors. Answer B contradicts the final paragraph's optimism about design interventions. Answer D contradicts the passage, which notes studies controlled for healthcare access. Answer E is too absolute; the passage says green space helps but does not claim it fully eliminates the gap.
...
**answer:** C
**explanation:** The passage specifically identifies proximity to green space, walkable neighborhoods, robust public transportation, and strong community organizations as factors that mitigate the urban mental health penalty. Answer C aligns with these findings. Answer A addresses treatment, not the environmental causes discussed. Answer B contradicts the passage's point that density itself is not the problem. Answer D is an extreme measure not suggested by the passage. Answer E is overly broad and not specifically supported.
...
**answer:** B
**explanation:** The passage presents both the Finnish and Kenyan experiments, notes their different outcomes, and concludes that context matters. Answer B captures this comparative, analytical structure. Answer A overstates the passage's position. Answer C misrepresents the passage's balanced treatment of the Finnish trial. Answer D describes only the Kenyan finding. Answer E is addressed briefly in the opening but is not the passage's main purpose.
...
**answer:** C
**explanation:** The passage states that in the Kenyan experiment, "recipients starting small businesses at twice the rate of non-recipients." Answer C is a direct statement from the passage. Answer D describes the Finnish experiment, not the Kenyan one. Answers A, B, and E describe outcomes not specifically attributed to the Kenyan experiment in the passage.
...
**answer:** C
**explanation:** The passage reports that supporters argued "the modest employment gains were unsurprising given that the Finnish labor market offered few available positions during the trial period." This implies that labor market conditions, not recipient behavior, constrained employment outcomes. Answer E contradicts the "unconditional" nature of basic income as described. Answer A is not mentioned as a factor. Answer B introduces cultural attitudes not discussed. Answer D is plausible but not specifically suggested by the passage.
...
**answer:** B
**explanation:** The passage concludes that basic income stimulates entrepreneurship "in economies where formal employment is scarce but entrepreneurial opportunities exist" and where "cash transfers may unlock productive activity that was previously constrained by a lack of startup capital." Answer B matches this profile: limited formal employment plus available opportunities (natural resources and market access). Answer C has limited formal employment but also barriers to entrepreneurship (strict licensing). Answers A and D describe settings with ample formal employment. Answer E would undermine the cash transfer's value.
...
**answer:** B
**explanation:** The passage makes two key arguments: first, that technology was the Silk Road's most important export (paragraph 1), and second, that transmission involved adaptive modification rather than direct copying (paragraphs 2-3). Answer B captures both points. Answer A is descriptive rather than analytical. Answer C focuses too narrowly on one example. Answer D misrepresents the passage, which does not claim European superiority. Answer E is not argued in the passage.
...
**answer:** B
**explanation:** The passage directly states that papermaking "is believed to have reached the Islamic world following the Battle of Talas in 751 CE, when Arab forces captured Chinese papermakers." Answer B is a precise restatement. All other options describe transmission mechanisms not mentioned in the passage.
...
**answer:** B
**explanation:** The passage's opening paragraph explicitly contrasts "popular accounts" that "emphasize the movement of luxury commodities" with the historians' recognition that "the Silk Road's most consequential exports were not physical objects but rather technologies and techniques." The remainder of the passage develops the theme of active reshaping. Answer A misrepresents the passage. Answer C describes a mechanism of trade not discussed. Answer D mentions military conflict only in the context of the Battle of Talas, not as an overlooked theme. Answer E contradicts the passage.
